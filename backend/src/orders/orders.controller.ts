...
export class OrdersController {
  ...
  @Get('unassigned')
  findUnassigned() { return this.ordersService.findUnassigned(); }

  @Get('stats')
  getStats() { return this.ordersService.getStats(); }

  @Get('tracking/:code')
  findByTracking(@Param('code') code: string) { return this.ordersService.findByTracking(code); }
  ...
  @Post(':id/assign')
  assignDriver(@Param('id', ParseIntPipe) id: number, @Body() dto: AssignDriverDto) {
    return this.ordersService.assignDriver(id, dto);
  }

  @Delete(':id')
  remove(@Param('id', ParseIntPipe) id: number) { return this.ordersService.remove(id); }
}
