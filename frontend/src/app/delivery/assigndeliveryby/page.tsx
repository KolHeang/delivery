              ...
              <div className="card" style={{ flex: 1, display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
                ...
                {loading ? (
                  ...
                  <div className="empty-state" style={{ margin: 'auto' }}>
                    ...
                    <div className="empty-state-title">{search ? 'No results found' : 'All orders assigned!'}</div>
                    <div className="empty-state-text">{search ? `No orders match "${search}"` : 'No pending unassigned orders'}</div>
                  </div>
                ) : (
