            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 24 }}>
                          ...
                          <div style={{ marginTop: 12 }}>
                            <div
                              style={{
                                ...
                                color: isFailed ? "#dc2626" : isCompleted ? "#0f172a" : "#94a3b8",
                              }}
                            >
              ...
              >
                ...
                >
                  ...
                  <div style={{ marginBottom: 16 }}>
                    ...
                    {(order.merchant?.nameKh || order.merchant?.name) &&
                      order.merchant?.name !== "-" && (
                        <div
                          style={{ fontWeight: 700, fontSize: 14, color: "#0f172a", marginTop: 4 }}
                        >
                          {order.merchant?.nameKh || order.merchant?.name}
                        </div>
                      )}
                    ...
                    {order.receiverPhone && (
                      <div
                        style={{
                          ...
                          alignItems: "center",
                          gap: 6,
                          marginTop: order.receiverName && order.receiverName !== "-" ? 3 : 4,
                        }}
                      >
                        <MdPhone size={14} />
                        <a
                ...
                >
                  ...
                  >
                    ...
                    >
                      ...
                      <div
                        style={{ fontSize: 18, fontWeight: 800, color: "#15803d", marginTop: 4 }}
                      >
                    ...
                    >
                      ...
                      <div
                        style={{ fontSize: 18, fontWeight: 800, color: "#0f172a", marginTop: 4 }}
                      >
                  ...
                  >
                    <div>
                      <span style={{ fontWeight: 600 }}>{tLocal.weight}:</span>{" "}
                      {order.weight || 0.5} kg
                    </div>
                    <div>
                      <span style={{ fontWeight: 600 }}>{tLocal.size}:</span>{" "}
                      <span style={{ textTransform: "capitalize" }}>{order.size || "small"}</span>
                    </div>
                  </div>
                ...
                >
                      ...
                      >
                        <div>
                          <div style={{ fontWeight: 700, fontSize: 14, color: "#0f172a" }}>
                            {lang === "km"
                              ? order.driver.nameKh || order.driver.name
                              : order.driver.name}
                          </div>
                  ...
                  {order.pickupDriver && (
                    <div
                      style={{ borderTop: "1px dashed #e2e8f0", paddingTop: 12, marginBottom: 14 }}
                    >
                      <div
                        style={{
                          fontSize: 11,
                      ...
                      <div
                        style={{ fontWeight: 600, fontSize: 13, color: "#0f172a", marginTop: 2 }}
                      >
              ...
              {order.histories && order.histories.length > 0 && (
                ...
                >
                  <div
                    style={{ fontSize: 15, fontWeight: 700, color: "#0f172a", marginBottom: 20 }}
                  >
                            ...
                            >
                              ...
                              >
                                <div style={{ fontWeight: 700, fontSize: 13, color: "#0f172a" }}>
                                  ...
                                  {h.note && (
                                    <span
                                      style={{ marginLeft: 8, color: "#475569", fontWeight: 500 }}
                                    >
                                      — {h.note}
                                    </span>
                                  )}
                              ...
                              {h.note && (
                                <div
                                  style={{
                                    ...
                                    padding: "8px 12px",
                                    background:
                                      h.status === "failed" || h.status === "returned"
                                        ? "#fef2f2"
                                        : "#f8fafc",
