...
interface Row {
  ...
  codUSD: number; codKHR: number; fee: number;
}

export default function Rpt2Page() {
  ...
  return (
    <div className="app-layout">
      ...
      <div className="main-content">
        <Topbar title={t('rpt2Title')} subtitle={t('operationReportTitle')} />
        <div className="page-content">
          <ReportHeader title={t('rpt2Title')} startDate={startDate} endDate={endDate} />
          ...
          <div className="card no-print" style={{ marginBottom: 18, padding: '14px 18px' }}>
            <div style={{ fontWeight: 700, fontSize: 14, marginBottom: 12 }}>{t('rpt2Title')}</div>
            ...
            <div className="card">
              <div style={{ overflowX: 'auto' }}>
                <table>
                  <thead>
                    <tr>
                      <th>{t('colNo')}</th><th>{t('colDriver')}</th>
