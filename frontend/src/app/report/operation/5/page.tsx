...
export default function Rpt5Page() {
  ...
  return (
    <div className="app-layout">
      ...
      <div className="main-content">
        <Topbar title={t('rpt5Title')} subtitle={t('operationReportTitle')} />
        <div className="page-content">
          <ReportHeader title={t('rpt5Title')} startDate={startDate} endDate={endDate} />
          ...
          <div className="card no-print" style={{ marginBottom: 18, padding: '14px 18px' }}>
            <div style={{ fontWeight: 700, fontSize: 14, marginBottom: 12 }}>{t('rpt5Title')}</div>
            ...
            <div className="card">
              <div style={{ overflowX: 'auto' }}>
                <table>
                  <thead>
                    <tr>
                      <th>{t('colNo')}</th><th>{t('colMerchant')}</th><th>{t('colDate')}</th>
